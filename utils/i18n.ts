...
const resources = {
  ...
  ru: {
    translation: {
      ...
      shopping: 'Покупки',
      profile: 'Профиль',
      'onboarding.welcome': 'Добро пожаловать в Nutrion',
      'onboarding.welcomeDesc': 'Ваш умный кухонный помощник, который помогает управлять продуктами, сокращать отходы и открывать удивительные рецепты.',
      'onboarding.pantryTitle': 'Умное отслеживание кладовой',
      'onboarding.pantryDesc': 'Добавляйте товары вручную или ищите в нашей базе данных. Легко отслеживайте все на вашей кухне.',
      'onboarding.aiTitle': 'Рецепты с ИИ',
      'onboarding.aiDesc': 'Получайте персонализированные идеи блюд на основе того, что у вас есть. Готовьте вкусные блюда без дополнительных покупок.',
      'onboarding.wasteTitle': 'Никогда не выбрасывайте еду',
      'onboarding.wasteDesc': 'Умные оповещения о сроке годности держат вас в курсе. Экономьте деньги и помогайте планете, сокращая пищевые отходы.',
      'pantry.title': 'Моя кладовая',
      'planner.title': 'Планировщик питания',
      'planner.ingredientsAvailable': 'Доступно ингредиентов: {{count}}',
      'shopping.title': 'Список покупок',
      'profile.title': 'Профиль',
      'subscription.title': 'Разблокируйте премиум-функции',
      'subscription.subtitle': 'Получите полный доступ ко всем функциям с нашей доступной подпиской',
      'subscription.month': 'месяц',
      'subscription.freeTrial': '30 дней бесплатно',
      'subscription.whatYouGet': 'Что вы получите',
      'subscription.feature1Title': 'Умное управление кладовой',
      'subscription.feature1Desc': 'Отслеживайте все продукты с оповещениями о сроке годности и умной категоризацией',
      'subscription.feature2Title': 'Рецепты с ИИ',
      'subscription.feature2Desc': 'Получайте персонализированные идеи блюд на основе имеющихся ингредиентов',
      'subscription.feature3Title': 'Синхронизация списка покупок',
      'subscription.feature3Desc': 'Автоматически создавайте списки покупок и синхронизируйте между устройствами',
      'subscription.feature4Title': 'Сокращение пищевых отходов',
      'subscription.feature4Desc': 'Экономьте деньги и помогайте окружающей среде с умным отслеживанием сроков годности',
      'subscription.trialInfo': 'Попробуйте бесплатно 30 дней, затем всего $1.99/месяц. Отмените в любое время.',
      'subscription.continue': 'Начать бесплатный пробный период',
      'subscription.disclaimer': 'Оплата не требуется в течение пробного периода',
      searchForFoods: 'Поиск продуктов',
      searchPlaceholder: 'Поиск продуктов...',
      searchHint: 'Введите не менее 2 символов для поиска',
      resultsFor: 'Результатов для "{{query}}": {{count}}',
  ...
  ar: {
    translation: {
      ...
      'onboarding.welcome': 'مرحباً بك في Nutrion',
      'onboarding.welcomeDesc': 'رفيقك الذكي في المطبخ الذي يساعدك على إدارة الطعام وتقليل الهدر واكتشاف وصفات رائعة.',
      'onboarding.pantryTitle': 'تتبع ذكي للمخزن',
      'onboarding.pantryDesc': 'أضف العناصر يدوياً أو ابحث في قاعدة البيانات الخاصة بنا. تتبع كل شيء في مطبخك بسهولة.',
      'onboarding.aiTitle': 'اقتراحات وصفات بالذكاء الاصطناعي',
      'onboarding.aiDesc': 'احصل على أفكار وجبات مخصصة بناءً على ما لديك. اطبخ وجبات لذيذة دون تسوق إضافي.',
      'onboarding.wasteTitle': 'لا تهدر الطعام أبداً',
      'onboarding.wasteDesc': 'تنبيهات ذكية لانتهاء الصلاحية تبقيك على اطلاع. وفر المال وساعد الكوكب من خلال تقليل هدر الطعام.',
      'pantry.title': 'مخزني',
      'planner.title': 'مخطط الوجبات',
      'planner.ingredientsAvailable': '{{count}} مكونات متاحة',
      'shopping.title': 'قائمة التسوق',
      'profile.title': 'الملف الشخصي',
      'subscription.title': 'افتح الميزات المميزة',
      'subscription.subtitle': 'احصل على وصول كامل لجميع الميزات باشتراكنا بأسعار معقولة',
      'subscription.month': 'شهر',
      'subscription.freeTrial': '30 يوماً تجربة مجانية',
      'subscription.whatYouGet': 'ما ستحصل عليه',
      'subscription.feature1Title': 'إدارة ذكية للمخزن',
      'subscription.feature1Desc': 'تتبع جميع الأطعمة مع تنبيهات انتهاء الصلاحية والتصنيف الذكي',
      'subscription.feature2Title': 'اقتراحات وصفات بالذكاء الاصطناعي',
      'subscription.feature2Desc': 'احصل على أفكار وجبات مخصصة بناءً على المكونات المتوفرة لديك',
      'subscription.feature3Title': 'مزامنة قائمة التسوق',
      'subscription.feature3Desc': 'إنشاء قوائم التسوق تلقائياً والمزامنة عبر الأجهزة',
      'subscription.feature4Title': 'تقليل هدر الطعام',
      'subscription.feature4Desc': 'وفر المال وساعد البيئة مع التتبع الذكي لانتهاء الصلاحية',
      'subscription.trialInfo': 'جرب مجاناً لمدة 30 يوماً، ثم $1.99/شهر فقط. إلغاء في أي وقت.',
      'subscription.continue': 'ابدأ التجربة المجانية',
      'subscription.disclaimer': 'لا يلزم الدفع خلال فترة التجربة',
      searchForFoods: 'البحث عن الأطعمة',
      searchPlaceholder: 'البحث عن الأطعمة...',
  ...
  el: {
    translation: {
      ...
      shopping: 'Ψώνια',
      profile: 'Προφίλ',
      'onboarding.welcome': 'Καλώς ήρθατε στο Nutrion',
      'onboarding.welcomeDesc': 'Ο έξυπνος σύντροφός σας στην κουζίνα που σας βοηθά να διαχειριστείτε τρόφιμα, να μειώσετε τα απόβλητα και να ανακαλύψετε καταπληκτικές συνταγές.',
      'onboarding.pantryTitle': 'Έξυπνη παρακολούθηση ντουλαπιού',
      'onboarding.pantryDesc': 'Προσθέστε αντικείμενα χειροκίνητα ή αναζητήστε στη βάση δεδομένων μας. Παρακολουθήστε τα πάντα στην κουζίνα σας με ευκολία.',
      'onboarding.aiTitle': 'Προτάσεις συνταγών με AI',
      'onboarding.aiDesc': 'Λάβετε εξατομικευμένες ιδέες γευμάτων με βάση αυτά που έχετε. Μαγειρέψτε νόστιμα γεύματα χωρίς επιπλέον ψώνια.',
      'onboarding.wasteTitle': 'Ποτέ μην πετάτε τρόφιμα',
      'onboarding.wasteDesc': 'Οι έξυπνες ειδοποιήσεις λήξης σας κρατούν ενήμερους. Εξοικονομήστε χρήματα και βοηθήστε τον πλανήτη μειώνοντας τα απόβλητα τροφίμων.',
      'pantry.title': 'Το ντουλάπι μου',
      'planner.title': 'Σχεδιαστής γευμάτων',
      'planner.ingredientsAvailable': '{{count}} διαθέσιμα υλικά',
      'shopping.title': 'Λίστα αγορών',
      'profile.title': 'Προφίλ',
      'subscription.title': 'Ξεκλειδώστε τις premium λειτουργίες',
      'subscription.subtitle': 'Αποκτήστε πλήρη πρόσβαση σε όλες τις λειτουργίες με την προσιτή συνδρομή μας',
      'subscription.month': 'μήνας',
      'subscription.freeTrial': '30 ημέρες δωρεάν δοκιμή',
      'subscription.whatYouGet': 'Τι θα λάβετε',
      'subscription.feature1Title': 'Έξυπνη διαχείριση ντουλαπιού',
      'subscription.feature1Desc': 'Παρακολουθήστε όλα τα τρόφιμά σας με ειδοποιήσεις λήξης και έξυπνη κατηγοριοποίηση',
      'subscription.feature2Title': 'Προτάσεις συνταγών με AI',
      'subscription.feature2Desc': 'Λάβετε εξατομικευμένες ιδέες γευμάτων με βάση τα υλικά που έχετε ήδη',
      'subscription.feature3Title': 'Συγχρονισμός λίστας αγορών',
      'subscription.feature3Desc': 'Δημιουργήστε αυτόματα λίστες αγορών και συγχρονίστε σε όλες τις συσκευές',
      'subscription.feature4Title': 'Μείωση απορριμμάτων τροφίμων',
      'subscription.feature4Desc': 'Εξοικονομήστε χρήματα και βοηθήστε το περιβάλλον με έξυπνη παρακολούθηση λήξης',
      'subscription.trialInfo': 'Δοκιμάστε δωρεάν για 30 ημέρες, μετά μόνο $1.99/μήνα. Ακυρώστε ανά πάσα στιγμή.',
      'subscription.continue': 'Ξεκινήστε τη δωρεάν δοκιμή',
      'subscription.disclaimer': 'Δεν απαιτείται πληρωμή κατά τη διάρκεια της δοκιμαστικής περιόδου',
      searchForFoods: 'Αναζήτηση τροφίμων',
      searchPlaceholder: 'Αναζήτηση τροφίμων...',
      searchHint: 'Πληκτρολογήστε τουλάχιστον 2 χαρακτήρες για αναζήτηση',
      resultsFor: '{{count}} αποτελέσματα για "{{query}}"',
      noResults: 'Δεν βρέθηκαν αποτελέσματα',
      tryDifferent: 'Δοκιμάστε έναν διαφορετικό όρο αναζήτησης',
    },
  },
  it: {
    translation: {
      ...
      shopping: 'Spesa',
      profile: 'Profilo',
      'onboarding.welcome': 'Benvenuto in Nutrion',
      'onboarding.welcomeDesc': 'Il tuo compagno intelligente in cucina che ti aiuta a gestire il cibo, ridurre gli sprechi e scoprire ricette straordinarie.',
      'onboarding.pantryTitle': 'Tracciamento intelligente della dispensa',
      'onboarding.pantryDesc': 'Aggiungi articoli manualmente o cerca nel nostro database. Tieni traccia di tutto nella tua cucina con facilità.',
      'onboarding.aiTitle': 'Suggerimenti di ricette AI',
      'onboarding.aiDesc': 'Ottieni idee per pasti personalizzate in base a ciò che hai. Cucina pasti deliziosi senza fare la spesa extra.',
      'onboarding.wasteTitle': 'Non sprecare mai il cibo',
      'onboarding.wasteDesc': 'Gli avvisi intelligenti di scadenza ti tengono informato. Risparmia denaro e aiuta il pianeta riducendo gli sprechi alimentari.',
      'pantry.title': 'La mia dispensa',
      'planner.title': 'Pianificatore pasti',
      'planner.ingredientsAvailable': '{{count}} ingredienti disponibili',
      'shopping.title': 'Lista della spesa',
      'profile.title': 'Profilo',
      'subscription.title': 'Sblocca le funzionalità premium',
      'subscription.subtitle': 'Ottieni accesso completo a tutte le funzionalità con il nostro abbonamento conveniente',
      'subscription.month': 'mese',
      'subscription.freeTrial': '30 giorni di prova gratuita',
      'subscription.whatYouGet': 'Cosa ottieni',
      'subscription.feature1Title': 'Gestione intelligente della dispensa',
      'subscription.feature1Desc': 'Traccia tutti i tuoi alimenti con avvisi di scadenza e categorizzazione intelligente',
      'subscription.feature2Title': 'Suggerimenti di ricette AI',
      'subscription.feature2Desc': 'Ottieni idee per pasti personalizzate in base agli ingredienti che hai già',
      'subscription.feature3Title': 'Sincronizzazione lista della spesa',
      'subscription.feature3Desc': 'Genera automaticamente liste della spesa e sincronizza tra dispositivi',
      'subscription.feature4Title': 'Riduci gli sprechi alimentari',
      'subscription.feature4Desc': 'Risparmia denaro e aiuta l\'ambiente con il tracciamento intelligente delle scadenze',
      'subscription.trialInfo': 'Prova gratuita per 30 giorni, poi solo $1.99/mese. Annulla in qualsiasi momento.',
      'subscription.continue': 'Inizia la prova gratuita',
      'subscription.disclaimer': 'Nessun pagamento richiesto durante il periodo di prova',
      searchForFoods: 'Cerca alimenti',
  ...
  no: {
    translation: {
      ...
      shopping: 'Handel',
      profile: 'Profil',
      'onboarding.welcome': 'Velkommen til Nutrion',
      'onboarding.welcomeDesc': 'Din smarte kjøkkenassistent som hjelper deg med å administrere mat, redusere avfall og oppdage fantastiske oppskrifter.',
      'onboarding.pantryTitle': 'Smart sporing av spiskap',
      'onboarding.pantryDesc': 'Legg til varer manuelt eller søk i databasen vår. Hold oversikt over alt på kjøkkenet ditt med letthet.',
      'onboarding.aiTitle': 'AI-oppskriftsforslag',
      'onboarding.aiDesc': 'Få personlige måltidsideer basert på det du har. Lag deilige måltider uten ekstra handel.',
      'onboarding.wasteTitle': 'Kast aldri mat',
      'onboarding.wasteDesc': 'Smarte utløpsvarsler holder deg informert. Spar penger og hjelp planeten ved å redusere matavfall.',
      'pantry.title': 'Mitt spiskap',
      'planner.title': 'Måltidsplanlegger',
      'planner.ingredientsAvailable': '{{count}} ingredienser tilgjengelig',
      'shopping.title': 'Handleliste',
      'profile.title': 'Profil',
      'subscription.title': 'Lås opp premiumfunksjoner',
      'subscription.subtitle': 'Få full tilgang til alle funksjoner med vårt rimelige abonnement',
      'subscription.month': 'måned',
      'subscription.freeTrial': '30 dagers gratis prøveperiode',
      'subscription.whatYouGet': 'Hva du får',
      'subscription.feature1Title': 'Smart spiskapstyring',
      'subscription.feature1Desc': 'Spor all maten din med utløpsvarsler og smart kategorisering',
      'subscription.feature2Title': 'AI-oppskriftsforslag',
      'subscription.feature2Desc': 'Få personlige måltidsideer basert på ingrediensene du allerede har',
      'subscription.feature3Title': 'Synkronisering av handleliste',
      'subscription.feature3Desc': 'Generer handlelister automatisk og synkroniser på tvers av enheter',
      'subscription.feature4Title': 'Reduser matavfall',
      'subscription.feature4Desc': 'Spar penger og hjelp miljøet med smart utløpssporing',
      'subscription.trialInfo': 'Prøv gratis i 30 dager, deretter bare $1.99/måned. Avbryt når som helst.',
      'subscription.continue': 'Start gratis prøveperiode',
      'subscription.disclaimer': 'Ingen betaling kreves i prøveperioden',
      searchForFoods: 'Søk etter mat',
      searchPlaceholder: 'Søk etter matvarer...',
      searchHint: 'Skriv minst 2 tegn for å søke',
      resultsFor: '{{count}} resultater for "{{query}}"',
  ...
  sv: {
    translation: {
      ...
      shopping: 'Shopping',
      profile: 'Profil',
      'onboarding.welcome': 'Välkommen till Nutrion',
      'onboarding.welcomeDesc': 'Din smarta köksassistent som hjälper dig att hantera mat, minska avfall och upptäcka fantastiska recept.',
      'onboarding.pantryTitle': 'Smart skafferiövervakning',
      'onboarding.pantryDesc': 'Lägg till varor manuellt eller sök i vår databas. Håll koll på allt i ditt kök med lätthet.',
      'onboarding.aiTitle': 'AI-receptförslag',
      'onboarding.aiDesc': 'Få personliga måltidsidéer baserat på vad du har. Laga läckra måltider utan extra shopping.',
      'onboarding.wasteTitle': 'Slösa aldrig mat',
      'onboarding.wasteDesc': 'Smarta utgångsdatumvarningar håller dig informerad. Spara pengar och hjälp planeten genom att minska matavfall.',
      'pantry.title': 'Mitt skafferi',
      'planner.title': 'Måltidsplanerare',
      'planner.ingredientsAvailable': '{{count}} ingredienser tillgängliga',
      'shopping.title': 'Inköpslista',
      'profile.title': 'Profil',
      'subscription.title': 'Lås upp premiumfunktioner',
      'subscription.subtitle': 'Få full tillgång till alla funktioner med vår prisvärda prenumeration',
      'subscription.month': 'månad',
      'subscription.freeTrial': '30 dagars gratis provperiod',
      'subscription.whatYouGet': 'Vad du får',
      'subscription.feature1Title': 'Smart skafferihantering',
      'subscription.feature1Desc': 'Spåra all din mat med utgångsdatumvarningar och smart kategorisering',
      'subscription.feature2Title': 'AI-receptförslag',
      'subscription.feature2Desc': 'Få personliga måltidsidéer baserat på ingredienser du redan har',
      'subscription.feature3Title': 'Synkronisering av inköpslista',
      'subscription.feature3Desc': 'Generera inköpslistor automatiskt och synkronisera mellan enheter',
      'subscription.feature4Title': 'Minska matavfall',
      'subscription.feature4Desc': 'Spara pengar och hjälp miljön med smart utgångsdatumspårning',
      'subscription.trialInfo': 'Prova gratis i 30 dagar, sedan bara $1.99/månad. Avbryt när som helst.',
      'subscription.continue': 'Starta gratis provperiod',
      'subscription.disclaimer': 'Ingen betalning krävs under provperioden',
      searchForFoods: 'Sök efter mat',
      searchPlaceholder: 'Sök efter matvaror...',
      searchHint: 'Skriv minst 2 tecken för att söka',
      resultsFor: '{{count}} resultat för "{{query}}"',
  ...
  is: {
    translation: {
      ...
      getStarted: 'Byrja',
      pantry: 'Búr',
      planner: 'Skipuleggjandi',
      shopping: 'Verslun',
      profile: 'Prófíll',
      'onboarding.welcome': 'Velkomin í Nutrion',
      'onboarding.welcomeDesc': 'Snjallur eldhúsfélaginn þinn sem hjálpar þér að stjórna mat, draga úr sóun og uppgötva frábærar uppskriftir.',
      'onboarding.pantryTitle': 'Snjöll búreftirlit',
      'onboarding.pantryDesc': 'Bættu við hlutum handvirkt eða leitaðu í gagnagrunninum okkar. Fylgstu með öllu í eldhúsinu þínu með auðveldum hætti.',
      'onboarding.aiTitle': 'AI uppskriftartillögur',
      'onboarding.aiDesc': 'Fáðu persónulegar máltíðarhugmyndir byggðar á því sem þú átt. Eldaðu ljúffengar máltíðir án auka verslunar.',
      'onboarding.wasteTitle': 'Sóaðu aldrei mat',
      'onboarding.wasteDesc': 'Snjallir gildistímaviðvaranir halda þér upplýstum. Sparaðu peninga og hjálpaðu jörðinni með því að draga úr matsóun.',
      'pantry.title': 'Búrið mitt',
      'planner.title': 'Máltíðaskipuleggjandi',
      'planner.ingredientsAvailable': '{{count}} hráefni tiltæk',
      'shopping.title': 'Innkaupalisti',
      'profile.title': 'Prófíll',
      'subscription.title': 'Opna úrvalseiginleika',
      'subscription.subtitle': 'Fáðu fullan aðgang að öllum eiginleikum með hagkvæmu áskriftinni okkar',
      'subscription.month': 'mánuður',
      'subscription.freeTrial': '30 daga ókeypis prufutímabil',
      'subscription.whatYouGet': 'Það sem þú færð',
      'subscription.feature1Title': 'Snjöll búrstjórnun',
      'subscription.feature1Desc': 'Fylgstu með öllum matvælum þínum með gildistímaviðvörunum og snjallri flokkun',
      'subscription.feature2Title': 'AI uppskriftartillögur',
      'subscription.feature2Desc': 'Fáðu persónulegar máltíðarhugmyndir byggðar á hráefnum sem þú átt nú þegar',
      'subscription.feature3Title': 'Samstilling innkaupalista',
      'subscription.feature3Desc': 'Búðu til innkaupalista sjálfkrafa og samstilltu á milli tækja',
      'subscription.feature4Title': 'Minnka matsóun',
      'subscription.feature4Desc': 'Sparaðu peninga og hjálpaðu umhverfinu með snjallri gildistímaeftirlit',
      'subscription.trialInfo': 'Prófaðu ókeypis í 30 daga, síðan bara $1.99/mánuður. Hætta hvenær sem er.',
      'subscription.continue': 'Byrja ókeypis prufutímabil',
      'subscription.disclaimer': 'Engin greiðsla krafist á prufutímabili',
      searchForFoods: 'Leita að mat',
      searchPlaceholder: 'Leita að matvælum...',
      searchHint: 'Sláðu inn að minnsta kosti 2 stafi til að leita',
      resultsFor: '{{count}} niðurstöður fyrir "{{query}}"',
      noResults: 'Engar niðurstöður fundust',
      tryDifferent: 'Prófaðu annað leitarorð',
    },
  },
  da: {
    translation: {
      ...
      profile: 'Profil',
      'onboarding.welcome': 'Velkommen til Nutrion',
      'onboarding.welcomeDesc': 'Din smarte køkkenassistent, der hjælper dig med at administrere mad, reducere spild og opdage fantastiske opskrifter.',
      'onboarding.pantryTitle': 'Smart spisekammersporing',
      'onboarding.pantryDesc': 'Tilføj varer manuelt eller søg i vores database. Hold styr på alt i dit køkken med lethed.',
      'onboarding.aiTitle': 'AI-opskriftsforslag',
      'onboarding.aiDesc': 'Få personlige måltidsidéer baseret på det, du har. Lav lækre måltider uden ekstra indkøb.',
      'onboarding.wasteTitle': 'Spild aldrig mad',
      'onboarding.wasteDesc': 'Smarte udløbsadvarsler holder dig informeret. Spar penge og hjælp planeten ved at reducere madspild.',
      'pantry.title': 'Mit spisekammer',
      'planner.title': 'Måltidsplanlægger',
      'planner.ingredientsAvailable': '{{count}} ingredienser tilgængelige',
      'shopping.title': 'Indkøbsliste',
      'profile.title': 'Profil',
      'subscription.title': 'Lås op for premiumfunktioner',
      'subscription.subtitle': 'Få fuld adgang til alle funktioner med vores overkommelige abonnement',
      'subscription.month': 'måned',
      'subscription.freeTrial': '30 dages gratis prøveperiode',
      'subscription.whatYouGet': 'Hvad du får',
      'subscription.feature1Title': 'Smart spisekammerstyring',
      'subscription.feature1Desc': 'Spor al din mad med udløbsadvarsler og smart kategorisering',
      'subscription.feature2Title': 'AI-opskriftsforslag',
      'subscription.feature2Desc': 'Få personlige måltidsidéer baseret på ingredienser, du allerede har',
      'subscription.feature3Title': 'Synkronisering af indkøbsliste',
      'subscription.feature3Desc': 'Generer indkøbslister automatisk og synkroniser på tværs af enheder',
      'subscription.feature4Title': 'Reducer madspild',
      'subscription.feature4Desc': 'Spar penge og hjælp miljøet med smart udløbssporing',
      'subscription.trialInfo': 'Prøv gratis i 30 dage, derefter kun $1.99/måned. Annuller når som helst.',
      'subscription.continue': 'Start gratis prøveperiode',
      'subscription.disclaimer': 'Ingen betaling kræves i prøveperioden',
      searchForFoods: 'Søg efter mad',
      searchPlaceholder: 'Søg efter fødevarer...',
      searchHint: 'Indtast mindst 2 tegn for at søge',
      resultsFor: '{{count}} resultater for "{{query}}"',
      noResults: 'Ingen resultater fundet',
      tryDifferent: 'Prøv et andet søgeord',
    },
  },
  fi: {
    translation: {
      ...
      shopping: 'Ostokset',
      profile: 'Profiili',
      'onboarding.welcome': 'Tervetuloa Nutrioniin',
      'onboarding.welcomeDesc': 'Älykäs keittiökumppanisi, joka auttaa sinua hallitsemaan ruokaa, vähentämään hävikkiä ja löytämään upeita reseptejä.',
      'onboarding.pantryTitle': 'Älykäs ruokakomeron seuranta',
      'onboarding.pantryDesc': 'Lisää tuotteita manuaalisesti tai etsi tietokannastamme. Pidä kirjaa kaikesta keittiössäsi helposti.',
      'onboarding.aiTitle': 'AI-reseptiehdotukset',
      'onboarding.aiDesc': 'Saa henkilökohtaisia ateriaideoita sen perusteella, mitä sinulla on. Valmista herkullisia aterioita ilman ylimääräisiä ostoksia.',
      'onboarding.wasteTitle': 'Älä koskaan tuhlaa ruokaa',
      'onboarding.wasteDesc': 'Älykkäät vanhentumishälytykset pitävät sinut ajan tasalla. Säästä rahaa ja auta planeettaa vähentämällä ruokahävikkiä.',
      'pantry.title': 'Ruokakomero',
      'planner.title': 'Ateriasuunnittelija',
      'planner.ingredientsAvailable': '{{count}} ainesosaa saatavilla',
      'shopping.title': 'Ostoslista',
      'profile.title': 'Profiili',
      'subscription.title': 'Avaa premium-ominaisuudet',
      'subscription.subtitle': 'Hanki täysi pääsy kaikkiin ominaisuuksiin edullisella tilauksella',
      'subscription.month': 'kuukausi',
      'subscription.freeTrial': '30 päivän ilmainen kokeilujakso',
      'subscription.whatYouGet': 'Mitä saat',
      'subscription.feature1Title': 'Älykäs ruokakomeron hallinta',
      'subscription.feature1Desc': 'Seuraa kaikkia ruokia vanhentumishälytyksillä ja älykkäällä luokittelulla',
      'subscription.feature2Title': 'AI-reseptiehdotukset',
      'subscription.feature2Desc': 'Saa henkilökohtaisia ateriaideoita jo olemassa olevien ainesosien perusteella',
      'subscription.feature3Title': 'Ostoslistan synkronointi',
      'subscription.feature3Desc': 'Luo ostoslistoja automaattisesti ja synkronoi laitteiden välillä',
      'subscription.feature4Title': 'Vähennä ruokahävikkiä',
      'subscription.feature4Desc': 'Säästä rahaa ja auta ympäristöä älykkäällä vanhentumisseurannalla',
      'subscription.trialInfo': 'Kokeile ilmaiseksi 30 päivää, sitten vain $1.99/kuukausi. Peruuta milloin tahansa.',
      'subscription.continue': 'Aloita ilmainen kokeilujakso',
      'subscription.disclaimer': 'Maksua ei vaadita kokeilujakson aikana',
      searchForFoods: 'Etsi ruokaa',
      searchPlaceholder: 'Etsi ruokia...',
      searchHint: 'Kirjoita vähintään 2 merkkiä hakeaksesi',
      resultsFor: '{{count}} tulosta haulle "{{query}}"',
      noResults: 'Tuloksia ei löytynyt',
      tryDifferent: 'Kokeile eri hakusanaa',
    },
  },
};
